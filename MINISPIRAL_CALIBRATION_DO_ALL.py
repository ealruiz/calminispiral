...
# First, set list of tracks: 
#        all tracks to combine the extended models in a unique CLEAN MODEL
#        only 1 track for calibration per track
...
# should be set to True if TRACKS includes two or more tracks
##############
